...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 16, fontFamily: "Inter_400Regular", lineHeight: 24, marginBottom: 28 },
  benefits: { gap: 16, marginBottom: 32 },
  benefitRow: { flexDirection: "row", alignItems: "center", gap: 14 },
  benefitIcon: { width: 26, height: 26, borderRadius: 13, alignItems: "center", justifyContent: "center" },
  benefitText: { fontSize: 16, fontFamily: "Inter_500Medium", flex: 1 },
  plans: { gap: 14 },
  planCard: {
    flexDirection: "row",
    alignItems: "center",
  ...
  savePill: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 100 },
  savePillText: { fontSize: 10, fontFamily: "Inter_700Bold", letterSpacing: 0.5 },
  planPrice: { fontSize: 17, fontFamily: "Inter_700Bold" },
  noPlans: { borderWidth: 1, borderRadius: 16, padding: 20, marginTop: 8 },
  noPlansText: { fontSize: 14, fontFamily: "Inter_400Regular", lineHeight: 22, textAlign: "center" },
  errorText: { fontSize: 14, fontFamily: "Inter_500Medium", marginTop: 20, textAlign: "center" },
  cta: { marginTop: 28, paddingVertical: 18, borderRadius: 100, alignItems: "center", justifyContent: "center" },
  ctaText: { fontSize: 18, fontFamily: "Inter_600SemiBold" },
  restoreBtn: { marginTop: 18, alignItems: "center", paddingVertical: 6 },
  restoreText: { fontSize: 15, fontFamily: "Inter_600SemiBold" },
  fineprint: { fontSize: 12, fontFamily: "Inter_400Regular", lineHeight: 18, textAlign: "center", marginTop: 20 },
  confirmOverlay: {
  ...
  confirmTitle: { fontSize: 20, fontFamily: "Inter_700Bold", marginBottom: 10 },
  confirmBody: { fontSize: 15, fontFamily: "Inter_400Regular", lineHeight: 22, marginBottom: 24 },
  confirmActions: { flexDirection: "row", gap: 12 },
  confirmBtn: { flex: 1, paddingVertical: 14, borderRadius: 100, alignItems: "center" },
