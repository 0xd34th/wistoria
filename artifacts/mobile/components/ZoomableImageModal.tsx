...
/**
 * Fullscreen, pinch-to-zoom + pan viewer for a single image. Used to let the
 * user maximize a redesign and inspect it up close. Double-tap toggles between
 * fit and 2x; releasing below 1x snaps back to fit.
 */
